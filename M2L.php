...
<section class="wrapper style2">
	<div class="container">
		<header class="major">
			<h2>PRESENTATION DE LA MAISON DES LIGUES DE LORRAINE</h2>
			<br>
			<p>La Maison des Ligues est un établissement du Conseil Régional. Ce n’est pas une entité juridique en propre.
				...
				comptables et juridiques. Entièrement financée par la région Lorraine, la Maison Régionale des Sports de Lorraine est gérée en partenariat par la région Lorraine et le Comité Régional Olympique et Sportif de Lorraine (CROSL) qui est l'initiateur d'une politique sportive régionale unitaire.</p>
		</header>
	</div>
</section>
...
<section class="wrapper style1">
	<div class="container">
		<div class="row gtr-200">
			<div id="content">
				<img src="images/maison-regionale.jpg" alt="..." class="img-rounded">
